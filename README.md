...
- Nix [quick_install](https://github.com/NathanaelLee15/Acorn/blob/main/scripts/quick_install.sh) script
    - main `curl -s https://raw.githubusercontent.com/NathanaelLee15/Acorn/refs/heads/main/scripts/quick_install.sh | bash`
    - dev  `curl -s https://raw.githubusercontent.com/NathanaelLee15/Acorn/refs/heads/dev/scripts/quick_install.sh | bash`
